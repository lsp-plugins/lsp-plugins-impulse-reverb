...
#define LSP_PLUGINS_IMPULSE_REVERB_VERSION_MICRO       36
...
namespace lsp
{
    namespace meta
    {
        ...
        #define IR_EQ_BAND(rev, id, name, alias, freq, freq_a)    \
            ADDON_CONTROL(rev, "eq_" id, "Band " name freq "Hz gain", "Eq " alias freq_a, U_GAIN_AMP, impulse_reverb_metadata::BA)
        ...
        static const port_t impulse_reverb_mono_ports[] =
        {
            ...
            IR_SAMPLE_FILE("2", " 3"),
            IR_SAMPLE_FILE("3", " 4"),
            IR_CONVOLVER_MONO("0", " 1", 1, 0, -100.0f),
            IR_CONVOLVER_MONO("1", " 2", 1, 1, +100.0f),
            IR_CONVOLVER_MONO("2", " 3", 2, 0, -100.0f),
            IR_CONVOLVER_MONO("3", " 4", 2, 1, +100.0f),
        ...
        static const port_t impulse_reverb_stereo_ports[] =
        {
            ...
            IR_SAMPLE_FILE("2", " 3"),
            IR_SAMPLE_FILE("3", " 4"),
            IR_CONVOLVER_STEREO("0", " 1", 1, 0, -100.0f, -100.0f),
            IR_CONVOLVER_STEREO("1", " 2", 1, 1, -100.0f, +100.0f),
            IR_CONVOLVER_STEREO("2", " 3", 2, 0, +100.0f, -100.0f),
            IR_CONVOLVER_STEREO("3", " 4", 2, 1, +100.0f, +100.0f),
        ...
        const meta::plugin_t impulse_reverb_mono =
        {
            ...
            "impulse_reverb_mono",
            {
                ...
                LSP_GST_UID("impulse_reverb_mono"),
            },
        ...
        const meta::plugin_t impulse_reverb_stereo =
        {
            ...
            "impulse_reverb_stereo",
            {
                ...
                LSP_GST_UID("impulse_reverb_stereo"),
            },
            LSP_PLUGINS_IMPULSE_REVERB_VERSION,
            plugin_classes,
